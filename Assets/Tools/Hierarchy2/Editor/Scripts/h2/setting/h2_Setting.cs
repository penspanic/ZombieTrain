...
namespace vietlabs.h2
{
    ...
    {
        private const string MESSAGE_ICON_DISABLED = "Icon being disabled !";
        private const string LABEL_CUSTOM_SELECTION_COLOR = "Custom selection color";
        private const string LABEL_CUSTOM_PLAYMODE_COLOR = "Custom playMode color";
