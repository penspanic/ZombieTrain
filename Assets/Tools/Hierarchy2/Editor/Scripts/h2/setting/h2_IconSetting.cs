...
namespace vietlabs.h2
{
    ...
    {
        private static readonly Color INDIE_ON = new Color32(0, 0, 0, 255);
        private static readonly Color INDIE_OFF = new Color32(175, 175, 175, 255);
        private static readonly Color INDIE_HALF = new Color32(64, 64, 64, 255);

        private static readonly Color PRO_ON = new Color32(195, 195, 0, 255);
        private static readonly Color PRO_OFF = new Color32(135, 135, 135, 255);
        private static readonly Color PRO_HALF = new Color32(128, 128, 0, 255);
        ...
        private static readonly Color[] inactiveColors =
        {
            PRO_OFF,
            INDIE_OFF
        };

        private static readonly Color[] halfColors =
        {
            PRO_HALF,
            INDIE_HALF
        };

        private static readonly Color[][] stateColors = {activeColors, inactiveColors, halfColors};
