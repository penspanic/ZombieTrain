...
namespace vietlabs.h2
{
    internal class h2_Combine : h2_Icon
    {
...
#if CACHE_INT
        private static readonly Dictionary<int, string> intCache = new Dictionary<int, string>();
#endif

	    public h2_Combine() : base("h2_Combine", 34f)
        {
        }
        ...
        private bool isCombined(Transform t)
        {
    ...
    {
        private const string TITLE = "CHILDREN COUNT";

        private static readonly string[] COMBINE_SHORTCUTS =
        {
