...
namespace vietlabs.h2
{
    internal class h2_Component : h2_Icon
    {
        ...
        private static void MoveChildren(Transform from, Transform to, string undoName)
        {
            if (to.childCount > 0)
    ...
    internal class h2_ComponentType
    {
        ...
        private static Dictionary<Type, h2_ComponentType> typeCache;
...
// WEIRD ? Ask Unity why, I don't know !
    ...
    internal class h2_GOCache
    {
        ...
        private static Dictionary<int, h2_GOCache> goCache;
    ...
    internal class h2_ComponentSetting : h2_FeatureSetting
    {
        ...
        private const string TITLE = "COMPONENT";
