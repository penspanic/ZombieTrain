...
namespace vietlabs.h2
{
    ...
    internal class h2_ActiveIconSetting : h2_IconSetting
    {
        ...
        private const string TITLE = "ACTIVE";
        private static readonly string[] ACTIVE_ICONS = {"eye", "eye_dis", "eye_dis"};
        private static readonly string[] ACTIVE_STATES = {"Active", "Inactive", "Self"};

        private static readonly string[] ACTIVE_SHORTCUTS =
        {
