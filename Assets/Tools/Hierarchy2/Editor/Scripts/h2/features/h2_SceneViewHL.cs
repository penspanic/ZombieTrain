...
namespace vietlabs.h2
{
    public class h2_SceneViewHL : h2_Icon
    {
        ...
        private static void DrawBox(Bounds? bound, Transform t, Color c)
        {
            ...
            if (t != null)
            {
	            ...
	            h2_Unity.HandlesDrawArrow(t.position, Quaternion.LookRotation(t.up), GREEN_A50);
	            h2_Unity.HandlesDrawArrow(t.position, Quaternion.LookRotation(t.forward), BLUE_A50);
	            h2_Unity.HandlesDrawArrow(t.position, Quaternion.LookRotation(t.right), RED_A50);
            }
    ...
    internal class h2_SceneViewHLSetting : h2_FeatureSetting
    {
        ...
        private const string TITLE = "SCENEVIEW HIGHLIGHT";
