...
namespace vietlabs.h2
{
    internal class h2_Prefab : h2_Icon
    {
        ...
        private const string tempName = "h2_dummy.prefab";

        // ----------------------------- API -----------------------------

        private static Dictionary<int, h2_PrefabInfo> cache;
        ...
        private static h2_PrefabInfo Get(GameObject go, float expireTime)
        {
    ...
    internal class h2_PrefabSetting : h2_IconSetting
    {
        ...
        private const string TITLE = "PREFAB";
        private static readonly string[] STATES = {"Prefab", "Model", "Missing", "Disconnect"};
        private static readonly string[] ICONS = {"cube", "cube", "cube", "cube"};

        private static readonly Color[][] THEME_COLORS =
        {
