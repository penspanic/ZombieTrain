...
namespace vietlabs.h2
{
    public class h2_Unity
    {
	    ...
	    public static void HandlesDrawArrow(Vector3 p, Quaternion q, Color c)
	    {
	    	var sz = HandleUtility.GetHandleSize(p);
		    Handles.color = c;
		    
	    	#if UNITY_5_6_OR_NEWER
	    	Handles.ArrowHandleCap(0, p, q, sz, EventType.Repaint);
	    	#else
	    	Handles.ArrowCap(0, p, q, sz);
	    	#endif
	    }
        ...
        private static FieldInfo[] renameFields;
        ...
        private static FieldInfo[] expandFields;

        internal static bool IsExpand(GameObject go)
        {
            var w = HierarchyWindow;
        ...
        public static Type InternalEditorUtilityT
        {
            get
            {
                return _InternalEditorUtilityT ?? (
                           _InternalEditorUtilityT =
                               h2_Reflection.GetTypeByName("UnityEditorInternal.InternalEditorUtility")
                       );
            }
        }
        ...
        public static Type GameObjectTreeViewDataSourceT
        {
            get
            {
                return _GameObjectTreeViewDataSourceT ?? (
                           _GameObjectTreeViewDataSourceT =
                               h2_Reflection.GetTypeByName("UnityEditor.GameObjectTreeViewDataSource")
                       );
            }
        }
