...
namespace vietlabs.h2
{
    internal class h2_Shortcut
    {
        ...
        private Dictionary<string, h2_AHandler> hndMap;
    ...
    {
        private const float CHAIN_DURATION = 0.3f;
        ...
        private void Filter(Dictionary<string, h2_AHandler> hndMap)
        {
            exactMatch.Clear();
            comboMatch.Clear();
        ...
        private void Trigger(List<h2_AShortcut> matchList)
        {
    ...
    {
        private const string LABEL_INVALID_SHORTCUT = "Invalid Shortcut!";
        private static readonly GUIContent LABEL_CTRL = new GUIContent("Ctrl");
        private static readonly GUIContent LABEL_ALT = new GUIContent("Alt");
        private static readonly GUIContent LABEL_SHIFT = new GUIContent("Shift");
        private static readonly Color COLOR_INVALID = new Color32(255, 128, 128, 255);

        private static Dictionary<int, string> helpMap;
        public bool alt;
        ...
        private void DrawKey(ref KeyCode key)
        {
        ...
        private static int GetUniqueId(bool ctrl, bool alt, bool shift, KeyCode key, KeyCode chain)
        {
    ...
    {
        private static h2_ShortcutWindow window;
        ...
        private static void UpdateShortcut(string shortcut)
        {
