...
namespace vietlabs.h2
{
    public class h2_Asset
    {
        public static T FindAsset<T>(string assetName) where T : Object
        {
            ...
            //#else
            string[] possibleAssets =
            {
                "Assets/Plugins/Editor/Hierarchy2/Graphic/",
                "Assets/Plugins/Editor/Hierarchy2/Editor/Graphic/",
                "Assets/Plugins/Hierarchy2/Graphic/",
                "Assets/Hierarchy2/Editor/Graphic/",
                "Assets/Hierarchy2/Graphic/"
            };

            //#endif
            foreach (var p in possibleAssets)
            {
                var asset = LoadAssetAtPath<T>(p + assetName);
                //Debug.Log(p + ":" + asset);
            ...
            where T : Object
        {
            ...
            foreach (var t in candidateList)
            {
                var asset = LoadAssetAtPath<T>(t);
                if (asset != null)
                {
