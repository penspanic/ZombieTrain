...
namespace Logic
{
    ...
    public class Joystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
    {
        ...
        public VirtualAxis HorizontalAxis { get; protected set; }
        public VirtualAxis VerticalAxis { get; protected set; }
        ...
        private void Awake()
        {
            ...
            HorizontalAxis = new VirtualAxis("Horizontal");
            VerticalAxis = new VirtualAxis("Vertical");
